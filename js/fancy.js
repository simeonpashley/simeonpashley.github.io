...
$(function() {
  var canvas = document.querySelector("#fancy-canvas");
  ...
  var voro = voronoi.voronoi().extent([[1, 1], [width - 1, height - 1]]);
  ...
  for (var i = 0; i <= width; i += 160) particles.push([i, 0], [i, height]);
  for (var i = 0; i <= height; i += 160) particles.push([0, i], [width, i]);
